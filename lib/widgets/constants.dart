...
class AppColors {
  ...
  static const Color secondary = Color.fromARGB(108, 15, 15, 15);
  static const Color secondaryLight = Color.fromARGB(255, 19, 21, 22);
  static const Color secondaryDark = Color.fromARGB(255, 16, 17, 17);
